...
contract EvaTribe is ERC721A, Ownable, KeeperCompatibleInterface {
    ...
    */
     ...
     * contract deployment.
     */
    constructor(string memory _baseUri, string memory _notRevealedUri) ERC721A("Eva", "EVA") {
        baseURI = _baseUri;
    ...
    function checkUpkeep(bytes calldata /* checkData */) external view override returns (bool upkeepNeeded, bytes memory /* performData */) {
        upkeepNeeded = address(this).balance > 500000000000000000 || totalSupply() == maxSupply && revealed == false;
    }
